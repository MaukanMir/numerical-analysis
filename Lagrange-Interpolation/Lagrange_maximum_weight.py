...
print("The maximum weights for sample 1: ", calculate_maximum_average_weight(sample_1,x))
print("The maximum weights for sample 2: ",calculate_maximum_average_weight(sample_2,x))
