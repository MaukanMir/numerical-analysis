...
# Approximate the first derivative at x = 0.5
first_derivative_approx = spline(0.5, 1)  # 1st derivative

# Print the results
print(f"Integral of Cubic Spline: {integral}")
print(f"Exact Integral of sin(x): {exact_integral}")
print(f"Error: {error}")
print(f"First Derivative (Approximation) at x=0.5: {first_derivative_approx}")
